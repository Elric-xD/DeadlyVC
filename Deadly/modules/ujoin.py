...
import asyncio
from Deadly import BOT_USERNAME, SUDO_USERS
from Deadly.core.decorators import authorized_users_only, sudo_users_only, errors
from Deadly.core.filters import command, other_filters
from Deadly import user as USER
